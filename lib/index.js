...
var _imageResolver = require('./plugins/imageResolver');
...
function reactNativeWebImageLoader(content) {
    var callback, query, wrapper, nameFormat, scalings, size, url, result, resolvedFiles, key, fileContent, fileName, publicPath;
    return _regenerator2.default.async(function reactNativeWebImageLoader$(_context) {
        while (1) {
